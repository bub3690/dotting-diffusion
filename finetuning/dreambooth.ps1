...
accelerate launch train_dreambooth.py --pretrained_model_name_or_path="runwayml/stable-diffusion-v1-5" `
--instance_data_dir="D:/project/dotting_ai/data/CHAR" `
--output_dir="D:/project/dotting_ai/data/dreambooth/spritesheet" `
--instance_prompt="DonaldTrump, spritesheet" --resolution=512 `
--train_batch_size=1 `
